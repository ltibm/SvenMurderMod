...
void PluginInit()
{
	...
	@cvar_KnifeThrow = @CCVar("knife_allow_throw", 1, "Enable throwing knife", ConCommandFlag::AdminOnly); 
	@cvar_KnifeDefaultGive = @CCVar("knife_default_give", 4, "Default give for knife ammo", ConCommandFlag::AdminOnly);
